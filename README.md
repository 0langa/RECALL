...
```bash
codex plugin marketplace add 0langa/RECALL --ref v1.5.3
...
The GitHub release asset is `recall.zip`. Users who install from GitHub should pin `--ref v1.5.3` for a stable install.
